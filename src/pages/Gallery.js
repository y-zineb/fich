...
const Gallery = () => {
  const albums = [
    ...
    },
    {
      ...
      images: [
        { src: '../assets/act2.1.jpeg', alt: "Journée Mondiale de l'Enseignant 1" },
        { src: '../assets/act2.2.jpeg', alt: "Journée Mondiale de l'Enseignant 2" },
      ]
    },
    {
    ...
    {
      title: "Journées Scientifiques 'Data Business à l'ère 4.0' - 19 Février 2024",
      images: [
